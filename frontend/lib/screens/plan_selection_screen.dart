...
class _PlanSelectionScreenState extends State<PlanSelectionScreen> {
  ...
  // Nullable to distinguish between "not loaded" and "free tier".
  String? _currentTier;
  ...
  Future<void> _loadCurrentSubscription() async {
    try {
      ...
      debugPrint(
        'Could not load subscription (might be during registration): $e',
      );
    }
  }
    ...
    try {
      ...
      if (result['success'] == true) {
        ...
        if (url != null) {
          ...
          if (await canLaunchUrl(uri)) {
            ...
            if (mounted) {
              showErrorSnackBar(
                context,
                AppLocalizations.of(context)!.errorOpeningPaymentPage,
              );
            }
          }
        }
        ...
        if (mounted) {
          showErrorSnackBar(
            context,
            AppLocalizations.of(context)!.errorStartingCheckout,
          );
        }
      }
    } catch (e) {
