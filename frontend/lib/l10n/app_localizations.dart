...
abstract class AppLocalizations {
  ...
  /// No description provided for @prepareFirstConversation.
  ///
  /// In en, this message translates to:
  /// **'Prepare First Conversation'**
  String get prepareFirstConversation;

  /// No description provided for @soloPreparationTitle.
  ///
  /// In en, this message translates to:
  /// **'Prepare your first conversation'**
  String get soloPreparationTitle;

  /// No description provided for @soloPreparationIntro.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @soloTopicLabel.
  ///
  /// In en, this message translates to:
  /// **'What do you want to talk about?'**
  String get soloTopicLabel;

  /// No description provided for @soloTopicHint.
  ///
  /// In en, this message translates to:
  /// **'Example: how we handle evenings after work'**
  String get soloTopicHint;

  /// No description provided for @soloFeelingLabel.
  ///
  /// In en, this message translates to:
  /// **'What are you feeling?'**
  String get soloFeelingLabel;

  /// No description provided for @soloFeelingHint.
  ///
  /// In en, this message translates to:
  /// **'Example: I feel distant and a little discouraged'**
  String get soloFeelingHint;

  /// No description provided for @soloNeedLabel.
  ///
  /// In en, this message translates to:
  /// **'What would help you feel heard?'**
  String get soloNeedLabel;

  /// No description provided for @soloNeedHint.
  ///
  /// In en, this message translates to:
  /// **'Example: I need us to listen without interrupting'**
  String get soloNeedHint;

  /// No description provided for @soloNextStepLabel.
  ///
  /// In en, this message translates to:
  /// **'What small next step would feel realistic?'**
  String get soloNextStepLabel;

  /// No description provided for @soloNextStepHint.
  ///
  /// In en, this message translates to:
  /// **'Example: a calm 15-minute conversation this weekend'**
  String get soloNextStepHint;

  /// No description provided for @soloInvitationPreviewTitle.
  ///
  /// In en, this message translates to:
  /// **'Invitation preview'**
  String get soloInvitationPreviewTitle;

  /// No description provided for @soloSaveDraft.
  ///
  /// In en, this message translates to:
  /// **'Save draft'**
  String get soloSaveDraft;

  /// No description provided for @soloUseForInvitation.
  ///
  /// In en, this message translates to:
  /// **'Use in partner invitation'**
  String get soloUseForInvitation;

  /// No description provided for @soloDraftSaved.
  ///
  /// In en, this message translates to:
  /// **'Draft saved'**
  String get soloDraftSaved;

  /// No description provided for @soloSafetyNote.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @soloDraftFallbackTopic.
  ///
  /// In en, this message translates to:
  /// **'something important between us'**
  String get soloDraftFallbackTopic;

  /// No description provided for @soloDraftFallbackFeeling.
  ///
  /// In en, this message translates to:
  /// **'I would like us to slow down and understand each other better'**
  String get soloDraftFallbackFeeling;

  /// No description provided for @soloDraftFallbackNeed.
  ///
  /// In en, this message translates to:
  /// **'I need a calmer space where we can both feel heard'**
  String get soloDraftFallbackNeed;

  /// No description provided for @soloDraftFallbackNextStep.
  ///
  /// In en, this message translates to:
  /// **'try a short guided conversation together'**
  String get soloDraftFallbackNextStep;

  /// No description provided for @soloInvitationDraft.
  ///
  /// In en, this message translates to:
  /// **'I would like us to talk about {topic}. I am feeling: {feeling}. What would help me is: {need}. Would you be open to {nextStep} with me on We Connect?'**
