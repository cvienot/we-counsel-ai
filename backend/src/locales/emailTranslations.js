...
- Safe space to communicate and grow together`,
    ...
    welcome: {
      subject: 'Welcome to We Connect',
      heading: (firstName) => `Hi ${firstName}!`,
      body: "Welcome to We Connect! We're excited to help you and your partner strengthen your relationship.",
      ...
      footer: 'We Connect - Strengthening relationships through guided communication',
      // Plain text version
      plainBody: (firstName) => `Hi ${firstName}!\n\nWelcome to We Connect! We're excited to help you and your partner strengthen your relationship.`,
...
3. Let our AI counsellor guide you through meaningful discussions`,
    ...
    messageNotification: {
      ...
      footer: 'We Connect - Strengthening relationships through guided communication',
      // Plain text version
      plainBody: (senderName) => `${senderName} has sent you a message on We Connect.`,
...
- Espace sûr pour communiquer et grandir ensemble`,
    ...
    welcome: {
      subject: 'Bienvenue sur We Connect',
      heading: (firstName) => `Bonjour ${firstName} !`,
      body: 'Bienvenue sur We Connect ! Nous sommes ravis de vous aider, vous et votre partenaire, à renforcer votre relation.',
      ...
      footer: 'We Connect - Renforcer les relations par une communication guidée',
      // Plain text version
      plainBody: (firstName) => `Bonjour ${firstName} !\n\nBienvenue sur We Connect ! Nous sommes ravis de vous aider, vous et votre partenaire, à renforcer votre relation.`,
...
3. Laissez notre conseiller IA vous guider dans des discussions significatives`,
    ...
    messageNotification: {
      ...
      footer: 'We Connect - Renforcer les relations par une communication guidée',
      // Plain text version
      plainBody: (senderName) => `${senderName} vous a envoyé un message sur We Connect.`,
...
- Espacio seguro para comunicarse y crecer juntos`,
    ...
    welcome: {
      subject: 'Bienvenido a We Connect',
      heading: (firstName) => `¡Hola ${firstName}!`,
      body: '¡Bienvenido a We Connect! Estamos emocionados de ayudarte a ti y a tu pareja a fortalecer su relación.',
      ...
      footer: 'We Connect - Fortaleciendo relaciones a través de la comunicación guiada',
      // Plain text version
      plainBody: (firstName) => `¡Hola ${firstName}!\n\n¡Bienvenido a We Connect! Estamos emocionados de ayudarte a ti y a tu pareja a fortalecer su relación.`,
...
3. Deja que nuestro consejero de IA te guíe en discusiones significativas`,
    ...
    messageNotification: {
      ...
      footer: 'We Connect - Fortaleciendo relaciones a través de la comunicación guiada',
      // Plain text version
      plainBody: (senderName) => `${senderName} te ha enviado un mensaje en We Connect.`,
